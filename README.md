...
> 当前版本：[`0.16.0` GitHub Release](https://github.com/zkwi/QuickPaste/releases/tag/v0.16.0)。请只从该 Release 下载严格命名的 Windows x64 NSIS 安装包或绿色版 ZIP。
...
- Enter、双击和 Alt + 数字快速粘贴；其中双击成功使用的记录会成为最新记录并移动到列表首位。支持键盘导航和中文输入法组合态保护；操作 Tooltip 会显示对应快捷键，设置页会提示常见粘贴快捷键语义冲突。
...
- [docs/releases/v0.16.0.md](docs/releases/v0.16.0.md)：v0.16.0 搜索与恢复体验的发布说明。
