...
> 当前版本：[`0.14.1` GitHub Release](https://github.com/zkwi/QuickPaste/releases/tag/v0.14.1)。请只从该 Release 下载严格命名的 Windows x64 NSIS 安装包或绿色版 ZIP。
...
- [docs/releases/v0.14.1.md](docs/releases/v0.14.1.md)：v0.14.1 顶部拖动可靠性修复的发布说明。
