...
- 记住并复核原顶层窗口与实际输入焦点子窗口，并兼容 Codex 等把输入渲染窗口放在协作进程中的桌面应用；恢复目标后自动回贴，目标失效或修饰键未释放时安全降级为仅复制。
...
- [docs/releases/v0.20.1.md](docs/releases/v0.20.1.md)：v0.20.1 Codex 等多进程窗口自动粘贴兼容修复的发布说明。
