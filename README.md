...
> 当前版本：[`0.14.0` GitHub Release](https://github.com/zkwi/QuickPaste/releases/tag/v0.14.0)。请只从该 Release 下载严格命名的 Windows x64 NSIS 安装包或绿色版 ZIP。
...
- [docs/releases/v0.14.0.md](docs/releases/v0.14.0.md)：v0.14.0 可复制数据目录与首次引导可靠性改进的发布说明。
