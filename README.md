...
> 当前版本：[`0.17.0` GitHub Release](https://github.com/zkwi/QuickPaste/releases/tag/v0.17.0)。请只从该 Release 下载严格命名的 Windows x64 NSIS 安装包或绿色版 ZIP。
...
- [docs/releases/v0.17.0.md](docs/releases/v0.17.0.md)：v0.17.0 定位与悬停预览体验的发布说明。
