...
> 当前版本：[`0.12.0` GitHub Release](https://github.com/zkwi/QuickPaste/releases/tag/v0.12.0)。请只从该 Release 下载严格命名的 Windows x64 NSIS 安装包或绿色版 ZIP。
...
- [docs/releases/v0.12.0.md](docs/releases/v0.12.0.md)：v0.12.0 快速面板、图片预览与管理/设置布局优化的发布说明。
