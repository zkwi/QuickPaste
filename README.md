...
> 当前版本：[`0.13.0` GitHub Release](https://github.com/zkwi/QuickPaste/releases/tag/v0.13.0)。请只从该 Release 下载严格命名的 Windows x64 NSIS 安装包或绿色版 ZIP。
...
- SQLite FTS5 支持中文子串、拼音/首字母、OCR、文件名、正文和来源应用搜索，并可组合类型、集合和固定状态筛选；结果使用稳定游标分页。
...
- [docs/releases/v0.13.0.md](docs/releases/v0.13.0.md)：v0.13.0 首次快捷粘贴练习、窗口拖动与托盘唤起优化的发布说明。
