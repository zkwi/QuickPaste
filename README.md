...
> 当前版本：[`0.15.0` GitHub Release](https://github.com/zkwi/QuickPaste/releases/tag/v0.15.0)。请只从该 Release 下载严格命名的 Windows x64 NSIS 安装包或绿色版 ZIP。
...
- SQLite FTS5 支持中文子串、拼音/首字母、OCR、文件名、正文和来源应用搜索，并可组合类型、集合和固定状态筛选；快速面板输入 `;`/`；` 只看永久片段，输入 `@` 可从来源建议中快速限定微信、飞书、WPS 或浏览器等应用；结果使用稳定游标分页。
...
- Enter、双击和 Alt + 数字快速粘贴，支持键盘导航和中文输入法组合态保护；操作 Tooltip 会显示对应快捷键，设置页会提示常见粘贴快捷键语义冲突。
...
- 在设置页或托盘检查 GitHub Release；发现新版后会在右下角弹出可操作通知，点击“下载安装”即可自动下载、核对 GitHub SHA-256 摘要并静默启动 NSIS 安装。
...
- [docs/releases/v0.15.0.md](docs/releases/v0.15.0.md)：v0.15.0 中文高频工作流与隐私增强的发布说明。
