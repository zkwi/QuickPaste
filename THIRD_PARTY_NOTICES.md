...
- [npm production 依赖](THIRD_PARTY_LICENSES_NPM.md)：28 个包；`package-lock.json` SHA-256 `0510ACBA5AAF657AE345C1C14EF22E49F5896AD8B0676A7AEDADC15FC769E48E`。
- [Rust Windows normal/build 依赖](THIRD_PARTY_LICENSES_RUST.md)：316 个第三方 crate；`src-tauri/Cargo.lock` SHA-256 `3D876A69600C0E206A0610B3DC29EA54D2B48BB62472D116B5EF0166117B27E1`。
